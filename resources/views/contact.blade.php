        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            ...
            <div class="flex items-stretch justify-center">
                <div class="grid md:grid-cols-2">
                    <div class="h-full md:px-12 md:pt-20 ">
                        ...
                        <ul class="mb-6 md:mb-0">
                            <li class="flex">
                                ...
                                <div class=" ml-4 mb-4">
                                    <h3 class="blockTitle mb-2 font-medium leading-6 ">Our Address
                                    </h3>
                                    <p class="">12 wash st</p>
                            ...
                            <li class="flex">
                                ...
                                <div class="ml-4 mb-4">
                                    <h3 class="blockTitle mb-2 leading-6">Contact
                                    </h3>
                                    <p class="">Mobile: +1 (123) 456-7890</p>
                                    <p class="">Mail: info@washmore.co.za</p>
                                </div>
                            </li>
                            <li class="flex">
                                <span class="icon flex h-12 w-12 items-center justify-center rounded-xl">
                                ...
                                <div class="  ml-4 mb-4">
                                    <h3 class="blockTitle mb-2 leading-6 ">Working
                                        hours</h3>
                    ...
                    <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                        <h2 class="blockTitle mb-4 text-2xl">Ready to Get Started?</h2>
                        <form id="contactForm">
                            <div class="mb-6">
                                <div class="mx-0 mb-1 sm:mb-4">
                                    <div class="mx-0 mb-1 sm:mb-4">
                                        <label for="name"
                                            ...
                                            class="mb-2 w-full  py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"
                                            name="name">
                                    </div>
                                    <div class="mx-0 mb-1 sm:mb-4">
                                        <label for="email"
                                ...
                                <div class="mx-0 mb-1 sm:mb-4">
                                    ...
                                    <textarea id="textarea" name="textarea" cols="30" rows="5" placeholder="Write your message..."
                                        class="mb-2 w-full  py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"></textarea>
                                </div>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="w-full btn px-6 py-3 font-xl rounded-md sm:mb-0">Send
                                    Message</button>
                            </div>
                        </form>
                    </div>
